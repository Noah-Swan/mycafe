//mf ca48 tchain
//H2_W_pmiss to check on cuts, flipped axis labels, fixed, just need to rerun
//calculated kf, ki, Pf,
//phi_pq 180 difference between MF and SRC
...
void skimhistos() 
{
	...
	const char* MF_File[8] = { "../Mf/Skim_Mf_D2/MF_D2_Results.root", "../Mf/Skim_Mf_Be9/MF_Be9_Results.root" , "../Mf/Skim_Mf_B10/MF_B10_Results.root" , "../Mf/Skim_Mf_B11/MF_B11_Results.root" , "../Mf/Skim_Mf_C12/MF_C12_Results.root" , "../Mf/Skim_Mf_Ca40/MF_Ca40_Results.root" , "../Mf/Skim_Mf_Ca48/MF_Ca48_Results.root" , "../Mf/Skim_Mf_Fe54/MF_Fe54_Results.root" };
	const char* SRC_File[8] = { "../Src/Skim_Src_D2/SRC_D2_Results.root", "../Src/Skim_Src_Be9/SRC_Be9_Results.root" , "../Src/Skim_Src_B10/SRC_B10_Results.root" , "../Src/Skim_Src_B11/SRC_B11_Results.root" , "../Src/Skim_Src_C12/SRC_C12_Results.root" , "../Src/Skim_Src_Ca40/SRC_Ca40_Results.root" , "../Src/Skim_Src_Ca48/SRC_Ca48_Results.root" , "../Src/Skim_Src_Fe54/SRC_Fe54_Results.root" };
