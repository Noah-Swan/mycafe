...
void analyze_simc_data() 
{
	...
	if (user_runtype == "MF")
	{
		if (user_target == "C12")
		{
			...
			{
				inROOT = new TFile("../../../../../../../../../work/hallc/c-cafe-2022/noahswan/hallc_simulations/beam_time_estimates/worksim/cafe_c12_MF_norad.root", "READ");
				OutputFileName = "outHist_C12_MF_norad.root";
				infile = "../../../../../../../../../work/hallc/c-cafe-2022/noahswan/hallc_simulations/beam_time_estimates/infiles/cafe_c12_MF_norad.data";
			}
			else if (user_radtype == "rad")
			{
				inROOT = new TFile("../../../../../../../../../work/hallc/c-cafe-2022/noahswan/hallc_simulations/beam_time_estimates/worksim/cafe_c12_MF_rad.root", "READ");
				OutputFileName = "outHist_C12_MF_rad.root";
				infile = "../../../../../../../../../work/hallc/c-cafe-2022/noahswan/hallc_simulations/beam_time_estimates/infiles/cafe_c12_MF_rad.data";
			}
	...
	else if (user_runtype == "SRC")
	{
		if (user_target == "D2")
		{
			if (user_radtype == "norad")
			{
				inROOT = new TFile("../../../../../../../../../work/hallc/c-cafe-2022/noahswan/hallc_simulations/beam_time_estimates/worksim/cafe_d2_SRC_norad.root", "READ");
				OutputFileName = "outHist_d2_MF_norad.root";
				infile = "../../../../../../../../../work/hallc/c-cafe-2022/noahswan/hallc_simulations/beam_time_estimates/infiles/cafe_d2_SRC_norad.data";
			}
			else if (user_radtype == "rad")
			{
				inROOT = new TFile("../../../../../../../../../work/hallc/c-cafe-2022/noahswan/hallc_simulations/beam_time_estimates/worksim/cafe_d2_SRC_rad.root", "READ");
				OutputFileName = "outHist_d2_MF_rad.root";
				infile = "../../../../../../../../../work/hallc/c-cafe-2022/noahswan/hallc_simulations/beam_time_estimates/infiles/cafe_d2_SRC_rad.data";
			}
			else { cout << "Couldn't find file." << endl; }
		}
		else { cout << "Couldn't find file." << endl; }
