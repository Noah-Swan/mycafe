...
/*
void compare_2histos(TString, TString, TString, TString,
	TString, TString, TString,
	TString, TString,
	bool, TFile*);
*/
...
//Begin Main
//*****************************************************************************************************************************************************************************
void calibrationhistos() 
{
	TFile* outROOT = new TFile("outHist.root", "RECREATE");
	
	const char* Target[8] = { "D2", "Be9", "B10", "B11", "C12", "Ca40", "Ca48", "Fe54" };
	
	const char* HMS_File_C[3] = { "../../OFFLINE/CALIBRATIONS/hodoscopes/hms_replay_production_all_4407_100000_hodCalib.root", "../../OFFLINE/CALIBRATIONS/drift_chambers/hms_replay_production_all_4407_100000_dcCalib.root", "calcalib/cafe_replay_calcalib_14967_c.root" };
	const char* HMS_File_Uc[3] = { "hms_replay_production_all_4407_1000000.root", "../../OFFLINE/CALIBRATIONS/drift_chambers/hms_replay_production_all_4407_-1_dcUnCalib.root", "calcalib/cafe_replay_calcalib_14967_uc.root" };
	const char* HMS_File_Run[8] = { "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/hms_Calib_histos16975.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/hms_Calib_histos16983.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/hms_Calib_histos16984.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/hms_Calib_histos16986.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/hms_Calib_histos16977.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/heavy_MF/hms_Calib_histos16980.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/heavy_MF/hms_Calib_histos17096.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/heavy_MF/hms_Calib_histos16982.root" };

	const char* SHMS_File_C[3] = { "../../OFFLINE/CALIBRATIONS/hodoscopes/shms_replay_production_all_17243_100000_hodCalib.root", "../../OFFLINE/CALIBRATIONS/drift_chambers/shms_replay_production_all_17243_100000_dcCalib.root", "calcalib/cafe_replay_calcalib_16962_c.root" };
	const char* SHMS_File_Uc[3] = { "shms_replay_production_all_17243_1000000.root", "../../OFFLINE/CALIBRATIONS/drift_chambers/shms_replay_production_all_17243_-1_dcUnCalib.root", "calcalib/cafe_replay_calcalib_16962_uc.root" };
	const char* SHMS_File_Run[8] = { "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/shms_Calib_histos16975.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/shms_Calib_histos16983.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/shms_Calib_histos16984.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/shms_Calib_histos16986.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/light_MF/shms_Calib_histos16977.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/heavy_MF/shms_Calib_histos16980.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/heavy_MF/shms_Calib_histos17096.root", "../../OFFLINE/CALIBRATIONS/cafe_checks/heavy_MF/shms_Calib_histos16982.root" };
	...
	bool SHMS_Dc = true;
	bool SHMS_Cal = true;
	bool SHMS_Light = true;
	bool SHMS_Heavy = true;


	const char* HMS_Hodo[11][4] = {	
		{"HMS Hodo Beta; Beta (p/E)", "H.hod.beta", "hms_hodo_beta.png", "HMS Hodo Beta"},
		{"HMS Calibrated Hodo; X Focal Plane [cm]; Beta (p/E)", "Beta [p/E]", "hms_hodo_beta_vs_xfp.png", "HMS Hodo Beta vs X_fp"}, 
